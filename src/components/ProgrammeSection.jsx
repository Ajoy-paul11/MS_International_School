        ...
        <div className=" p-6 lg:p-8">
          <div className=" max-w-7xl mx-auto h-full flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-10 p-2">
            <div className=" w-full p-4 lg:p-6 rounded-lg bg-color primary-text-color">
              <h2 className=" text-3xl lg:text-4xl font-bold text-start mb-8 pl-2">
                CBSE
              </h2>
            ...
            <div className=" lg:w-[150%] cta-text-color text-lg lg:text-xl font-semibold ">
              <b> MS International Public school</b> aims at offering all our
              students a broad and balanced curriculum that provides rewarding
              and stimulating activities to prepare them for the best social and
