...
const hostelFacilities = [
  { hostelImages: [hostel1, hostel2, hostel3, hostel4, hostel5] },
  { kitchenImages: [kitchen1, kitchen2, kitchen3, kitchen4, kitchen5] },
];
  ...
  return (
    <div>
      <div>
        ...
        {hostelFacilities.map((hostelFacility, index) =>
          hostelFacility.hostelImages ? (
            <div key={index} className=" w-full cta-color flex flex-col gap-y-12 lg:flex-row justify-center items-center p-8 px-2 md:px-0 lg:px-4 xl:p-12">
              <div className=" w-full lg:w-1/2 cta-text-color p-2 order-2 text-lg lg:text-xl xl:text-2xl md:px-4">
                <div className="my-2 ">
                  The Institute provides boarding and lodging facilities for
                  boys and students staying away from home. A new hostel
                  provides quality food and hygienic living spaces. Students
                  will have to adhere to hostel timings and rules without
                  compromise.
                  <p className="my-6">
                    Being located on the campus, the hostellers are free to make
              ...
              <div className=" w-full lg:w-1/2 order-1 lg:order-2">
                <div className=" px-2 md:px-4 lg:px-0 xl:px-4">
                  <Carousel autoPlay infiniteLoop showThumbs={false}>
                    {hostelFacility.hostelImages.map((image, index) => (
                      <div key={index}>
                        <img
                          src={image}
                          alt="hostel-image"
            ...
            <div key={index} className=" w-full cta-color flex flex-col gap-y-12 lg:flex-row justify-center items-center p-8 px-2 md:px-0 lg:px-4 xl:p-12">
              <div className=" w-full lg:w-1/2 order-1 lg:order-2">
                <div className=" px-2 md:px-4 lg:px-0 xl:px-4">
                  <Carousel autoPlay infiniteLoop showThumbs={false}>
                    {hostelFacility.kitchenImages.map((image, index) => (
                      <div key={index}>
                        <img
                          src={image}
                          alt="kitchen-image"
              ...
              <div className=" w-full lg:w-1/2 cta-text-color p-2 order-2 text-lg xl:text-2xl md:px-4">
                <div className="my-2 ">
                  The Hostel provides quality food and hygienic living space.
                  The hostel is located inside the school campus to enable an
                  easy and quick commute.
                  <div className="mt-2">
                    <h4 className="mt-2 font-semibold">Mess Includes:</h4>
                    <ul className="list-disc list-inside">
                      <li>
                        Freshly prepared and hygienic meals for kids at the
                        hostel.
                      </li>
                      <li>
                        Breakfast + Lunch + Dinner are provided on all days.
                      </li>
                      <li>
                        Breakfast + Lunch + Dinner on Sundays and school
                        holidays as well.
                      </li>
                    </ul>
                  </div>
